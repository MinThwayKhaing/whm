 ...
 * @Date 2017-02-27
 * @author eimon
 * @Purpose <<mainly for Registration Page>>
 *
 *
 ***************************************************************************************/
...
/***************************************************************************************
 * Updated By : Ye Thu Naing, Sai Kyaw Ye Myint Updated Date : 2017/06/30
 * Updated For : Phase II Explanation : 1) Add customized validation methods for
 * controls. 2) Add addRow() method for Add Record button. 3) Modify back()
 * method to be able to transit to weekly activity inquiry.
 ***************************************************************************************/

@ManagedBean(name = "DailyActivityManageBean")
@ViewScoped
public class DailyActivityManageBean extends BaseBean {
	 ...
	 * Explanation : Modified activity hour from 7.0 to 7.5.
	 * 				 Added defaultLeaveDescription and suggestMessage.
	 */
	
	/**
	 * Revised By : Aye Myat Mon
	 * Revised Date : 2018/08/20
	 * Explanation : Modified defaultLeaveDescription.
	 */
	...
	/** Revised By Sai Kyaw Ye Myint on 2018/07/27. */
	 ...
	 * Added screenId, getter and setter method for back button process.
	 */
	...
	public void load() {
		...
		/** Revised By Ye Thu Naing on 2017/07/10. */
	...
	/** Revised By Ye Thu Naing on 2017/07/10. */
	// public int getCalendarDisabled() {
	// return calendarDisabled;
	// }
	//
	// public void setCalendarDisabled(int calendarDisabled) {
	 ...
	 * Revised By : Sai Kyaw Ye Myint
	 * Revised Date : 2018/07/27
	 * Explanation : Added checkTotalHour method to check total hour before save.
	 */
	 ...
	 * II Explanation : Add customized validation methods for controls.
	 */
	...
	public void save() {
		try {
			...
			/**
			    ...
			    * Explanation: Add total hours column to save daily report table
			    */  
			switch (leaveStatus) {
			case 0:
			...
			// return SUCCESS;
			// DailyActivitySuccessManageBean.showActivities(dailyReport);
			// return "home";
	...
	/**
	 * Revised By : Ye Thu Naing Revised Date : 2017/06/30 Updated For : Phase
	 * II Explanation : Adding a new row to "Daily Progress List".
	 */
	public void addRow() {
		dailyActivity = new DailyActivity();
		dailyActivityList.add(dailyActivity);
	...
	/**
	 * Revised By : Ye Thu Naing Revised Date : 2017/06/30 Updated For : Phase
	 * II Explanation : Customized validation method for "Description".
	 */
	...
	/**
	 * Revised By : Ye Thu Naing Revised Date : 2017/06/30 Updated For : Phase
	 * II Explanation : Customized validation method for "Hour".
	 */
