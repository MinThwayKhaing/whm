...
import com.dat.whm.dailyactivity.service.interfaces.IDailyActivityTestService;
...
@Service("DailyActivityTestService")
public class DailyActivityTestService implements IDailyActivityTestService {
...
private Logger logger = Logger.getLogger(this.getClass());
	...
	@Resource(name = "DailyActivityTestDAO")
	private IDailyActivityTestDAO dailyActivityTestDAO;
	...
	public ArrayList<DailyActivityTest> removeDuplicate(List<DailyActivityTest> dailyActivityList){
		SimpleDateFormat YearFormat = new SimpleDateFormat("yyyy");
		SimpleDateFormat MonthFormat = new SimpleDateFormat("MM");
		ArrayList<DailyActivityTest> updateddailyActivityData = new ArrayList<DailyActivityTest>();
		List<DailyActivityTest> arr = dailyActivityList;
		int cnt= 0;
       ...
       if(cnt<1){
    	   DailyActivityTest da = new DailyActivityTest();
	...
	public ArrayList<DailyActivityTest> calculateTotalHourBySameProject(List<DailyActivityTest> dailyActivityList,List<DailyActivityTest> updateddailyActivityData){
		ArrayList<DailyActivityTest> updateddailyActivityList = new ArrayList<DailyActivityTest>();
		Double prj_hour = 0.0;
		Double nullprj_hour = 0.0;
		SimpleDateFormat YearFormat = new SimpleDateFormat("yyyy");
		SimpleDateFormat MonthFormat = new SimpleDateFormat("MM");
		
		for(DailyActivityTest da1 : updateddailyActivityData){
			DailyActivityTest da = new DailyActivityTest();
			for(DailyActivityTest da2 : dailyActivityList){
	...
	@Transactional(propagation = Propagation.REQUIRED)
	  public void save(List<DailyActivityTest> dailyActivityList,boolean adminFlag,String staffId,User loginUser,DailyReport dailyReport){
	...
	try{
			...
			//Add new record with new project id and update total hours on existing project id in insert page	
			 for (DailyActivityTest d : updateddailyActivityList) {
				  count = 0;
	...
	@Transactional(propagation = Propagation.REQUIRED)
	  public void calculationUpdate(ArrayList<DailyActivityTest> updateddailyActivityList,Date updateDate,boolean del_flag,boolean adminFlag,String staffId,User loginUser,DailyReport dailyReport )
	  {
			SimpleDateFormat YearFormat = new SimpleDateFormat("yyyy");
			SimpleDateFormat MonthFormat = new SimpleDateFormat("MM");
			...
			report_user = loginUser;
			ArrayList<DailyActivityTest> updateddailyActivityData = new ArrayList<DailyActivityTest>();
			ArrayList<DailyActivityTest> updateddailyActivity = new ArrayList<DailyActivityTest>();
			...
			for(DailyActivityTest da:updateddailyActivity){
				update_flag = false;
	...
	public Date getEarliestDate(DailyActivityTest old_d,DailyReport dailyReport,User old_user){
		...
		if(old_d.getProject() != null){
			monthlyReportList = dailyActivityTestDAO.findReportByMonthly(old_d.getProject().getId(), old_d.getDailyReport().getStaffID().getId(), yearmonth.format(old_d.getDailyReport().getActivityDate()),old_user.getMainlyBelongTeam().getId());
			}else{
			monthlyReportList = dailyActivityTestDAO.findReportByMonthly(null, old_d.getDailyReport().getStaffID().getId(), yearmonth.format(old_d.getDailyReport().getActivityDate()),old_user.getMainlyBelongTeam().getId());	
			}
	  ...
	  @Transactional(propagation = Propagation.REQUIRED)
	  public void updateSummaryActivity(boolean adminFlag,String staffId,User loginUser,DailyReport dailyReport,List<DailyActivityTest> dailyActivityList,Date oldDate,List<DailyActivityTest> tempDailyActivityList) {
			SimpleDateFormat YearFormat = new SimpleDateFormat("yyyy");
			SimpleDateFormat MonthFormat = new SimpleDateFormat("MM");
			SimpleDateFormat yearmonth = new SimpleDateFormat("yyyyMM");
			Double total_activity_hours = 0.0;
			...
			List<DailyActivityTest> newdailyActivityList = new ArrayList<DailyActivityTest>();
			ArrayList<DailyActivityTest> updateddailyActivityList = new ArrayList<DailyActivityTest>();
			ArrayList<DailyActivityTest> inserteddailyActivityList = new ArrayList<DailyActivityTest>();
			...
			if(newdailyActivityList.size() == 0 && tempDailyActivityList.size() > 0 || newdailyActivityList.size() > 0 && tempDailyActivityList.size() == 0){
				...
				for (DailyActivityTest old_d : tempDailyActivityList) {
					DailyActivityTest da = new DailyActivityTest();
			...
			if(!oldDate.toString().equals(dailyReport.getActivityDate().toString())){
				...
				temp: for (int i = 0; i < tempDailyActivityList.size(); i++) {
					...
					for (DailyActivityTest d : newdailyActivityList) {
					...
					if(tempDailyActivityList.get(i).getProject() !=null){
						monthlyReportList = dailyActivityTestDAO.findReportByMonthly(tempDailyActivityList.get(i).getProject().getId(), tempDailyActivityList.get(i).getDailyReport().getStaffID().getId(), yearmonth.format(tempDailyActivityList.get(i).getDailyReport().getActivityDate()),delete_user.getMainlyBelongTeam().getId());
						if(monthlyReportList.size() > 0){
						for (int j = 0; j < monthlyReportList.size(); j++) {
						...
						monthlyReportList = dailyActivityTestDAO.findReportByMonthly(null, tempDailyActivityList.get(i).getDailyReport().getStaffID().getId(), yearmonth.format(tempDailyActivityList.get(i).getDailyReport().getActivityDate()),delete_user.getMainlyBelongTeam().getId());
						if(monthlyReportList.size() > 0){
						for (int j = 0; j < monthlyReportList.size(); j++) {
						dr.setStaffID(tempDailyActivityList.get(i).getDailyReport().getStaffID());
						dr.setActivityDate((Date)monthlyReportList.get(j)[2]);	
				...
				for(DailyActivityTest new_d: newdailyActivityList){
					boolean found = false;
					
					
					DailyActivityTest da = new DailyActivityTest();
					DailyActivityTest da2 = new DailyActivityTest();
					DailyActivityTest da3 = new DailyActivityTest();
					for (DailyActivityTest old_d : tempDailyActivityList) {
	...
	public DailyActivityTest addNewDailyActivity(DailyActivityTest DailyActivityTest) throws SystemException {
		try {
			...
			DailyActivityTest = dailyActivityTestDAO.insert(DailyActivityTest);
			...
			throw new SystemException(e.getErrorCode(), "Faield to add a DailyActivityTest", e);
		}
	...
	public void saveDailyReportData(DailyReport dailyReport,List<DailyActivityTest> dailyActivityList,List<DailyActivityTest> tempDailyActivityList,boolean editFlag,List<DailyReport> result,boolean adminflag,String staff,User loginuser,Date oldDate) throws SystemException {
		try {
			...
			for (DailyActivityTest d : dailyActivityList) {
			...
			if (editFlag) {
				...
				a: for (int i = 0; i < dailyActivityList.size(); i++) {
					...
					for (DailyActivityTest d : tempDailyActivityList) {
						if(!d.getTaskDescription().equals("Half Leave")){
						if (dailyActivityList.get(i).getTempId() == d.getTempId()) {
							
							dailyActivityTestDAO.update(dailyActivityList.get(i));
					...
					dailyActivityTestDAO.insert(dailyActivityList.get(i));
				...
				if(dailyreportlist.size() > 0){
					for(DailyReport dr: dailyreportlist){
						 List<DailyActivityTest> activitylist = dailyActivityTestDAO.findActivityByReportID(dr);
						...
						dailyReportDAO.delete(dailyreportlist);
							 ...
							 for (int i = 0; i < activitylist.size(); i++) {
								dailyActivityTestDAO.delete(activitylist.get(i));
							}
							 dailyReportDAO.delete(dailyreportlist);	
						 }
						 }
				...
				a: for (int i = 0; i < tempDailyActivityList.size(); i++) {
					...
					dailyActivityTestDAO.delete(tempDailyActivityList.get(i));
				}
				}
				}
	...
	public DailyActivityTest updateDailyActivity(DailyActivityTest DailyActivityTest) throws SystemException {
		try {
			...
			DailyActivityTest = dailyActivityTestDAO.update(DailyActivityTest);
			...
			throw new SystemException(e.getErrorCode(),
					"Faield to update DailyActivityTest", e);
		}
		return DailyActivityTest;
	}
	...
	public List<DailyActivityTest> findActivityByReportID(DailyReport dailyReport) throws SystemException {
		...
		List<DailyActivityTest> result = dailyActivityTestDAO.findActivityByReportID(dailyReport);
	...
	public void deleteDailyActivityByReportID(DailyReport dailyReport) throws SystemException {
		...
		try {
			...
			dailyActivityTestDAO.deleteByReportID(dailyReport);
	...
	public List<DailyActivityTest> findAllActivitiesByCriteria(
		...
		try {
			...
			result = dailyActivityTestDAO.findAllActivitiesByCriteria(dailyReport, DailyActivityTest);
	...
	public Date findActivityDateByProjectID(String projectID) throws SystemException {
		...
		try {
			...
			result = dailyActivityTestDAO.findActivityDateByProjectID(projectID);
	...
	try {
		...
		result = dailyActivityTestDAO.findMinDateByProjectID(projectId);
	...
	try {
		...
		result = dailyActivityTestDAO.findMaxDateByProjectID(projectId);
	...
	try {
		...
		result = dailyActivityTestDAO.findSumOfActivityHrByProjectID(projectId);
	...
	try {
		...
		result = dailyActivityTestDAO.countActivityDateByProjectID(projectId);
	...
	try {
		...
		result = dailyActivityTestDAO.findReportByMonthly(projectid,staffid,reportdate,team_id);
